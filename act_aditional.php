...
if (!empty($_POST["submit"])) {
	...
	$actAditional++;	
	$query = "UPDATE clientienergie set nr_aa = '".$actAditional."' WHERE  id=".$_GET["id"];
	...
	$astazi = date("d.m.Y");
	$data = '';
	$data .='<h3 align="center" style="font-size:12px">Act aditional nr. ' . $nraa . ' din ' . $astazi . '<br />' . 'la ' . ' <br /> ' . 'Contractul de furnizare a energiei electrice nr.' . $nrContract . ' din data '.$_POST["data_semnare"].'</h3>';
	...
	$mpdf->writeHTML($data);
	$mpdf->Output('AA nr. ' .$nraa. ' ' . $numeClient .'.pdf', 'D');
            ...
            <div class='container'>
                <div class='card'>
                    <div class='card-header'>
                        <h1>Act aditional Energie Electrica</h1>
                    </div>
                    <div class='card-body'>
