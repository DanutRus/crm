<?php 
	...
	$query = "SELECT * FROM clientienergie WHERE id >0 ";
...
<div class='dashboard'>
    <div class="dashboard-nav">
		...
		<nav class="dashboard-nav-list">
			...
			<a href="profitagenti.php" class="dashboard-nav-item active">Profit agenti EE</a>
            ...
            <div class='container'>
                <div class='card'>
                    <div class='card-header'>
						<h1>Profitabilitate / Agent Energie Electrica</h1>
                    </div>
                    <div class='card-body'>
					<form name="" method="post" action="profitagenti.php">
					<span>Agent</span>
