                ...
                <div class='card'>
					...
					<form name="" method="post" action="">
						<div class="formular-adaugare-client">
							...
							<div class="form-group mb-3">
									<span>Judet</span>
									<input type="type" name="judet" class="form-control" value="<?php echo $result[0]["judet"];?>">
							</div>
							<div class="form-group mb-3">
							<div class="col">
									...
									<option selected>Alege</option>
										...
										<option value="BRM GN" <?php if($result[0]["agent_nova"] == "BRM GN") echo 'selected="selected"';?>>BRM GN</option>
									</select>
								</div>
							</div>
							<div class="form-group mb-3">
							...
							<div class="form-group mb-3">
									...
									<div class="col">
											...
											<input type="text" name="distributiegn" class="form-control" value="<?php echo $result[0]["distributiegn"];?>">
									</div>
									<div class="col">
											<span>SRM</span>
											<input type="text" name="srm" class="form-control" value="<?php echo $result[0]["srm"];?>">
									</div>
							<div class="form-group mb-3">
							...
							<div class="form-group mb-3">
									...
									<select name="clauza_penalitati_rez" class="custom-select">
										<option selected>Alege</option>
										<option value="Da" <?php if($result[0]["clauza_penalitati_rez"] == "Da" || $result[0]["clauza_penalitati_rez"] == "DA") echo 'selected="selected"'; ?>>Da</option>
										<option value="Nu" <?php if($result[0]["clauza_penalitati_rez"] == "Nu" || $result[0]["clauza_penalitati_rez"] == "NU") echo 'selected="selected"'; ?>>Nu</option>
									</select>
							</div>
							<div class="form-group mb-3">
									...
									<select name="cuantum_penalizare" class="custom-select">
										<option selected>Alege</option>
										<option value="0%" <?php if($result[0]["cuantum_penalizare"] == "0%" || $result[0]["cuantum_penalizare"] == "0") echo 'selected="selected"'; ?>>0%</option>
										<option value="10%" <?php if($result[0]["cuantum_penalizare"] == "10%" || $result[0]["cuantum_penalizare"] == "10") echo 'selected="selected"'; ?>>10%</option>
										<option value="20%" <?php if($result[0]["cuantum_penalizare"] == "20%" || $result[0]["cuantum_penalizare"] == "20") echo 'selected="selected"'; ?>>20%</option>
										<option value="30%" <?php if($result[0]["cuantum_penalizare"] == "30%" || $result[0]["cuantum_penalizare"] == "30") echo 'selected="selected"'; ?>>30%</option>
										<option value="40%" <?php if($result[0]["cuantum_penalizare"] == "40%" || $result[0]["cuantum_penalizare"] == "40") echo 'selected="selected"'; ?>>40%</option>
										<option value="50%" <?php if($result[0]["cuantum_penalizare"] == "50%" || $result[0]["cuantum_penalizare"] == "50") echo 'selected="selected"'; ?>>50%</option>
										<option value="60%" <?php if($result[0]["cuantum_penalizare"] == "60%" || $result[0]["cuantum_penalizare"] == "60") echo 'selected="selected"'; ?>>60%</option>
										<option value="70%" <?php if($result[0]["cuantum_penalizare"] == "70%" || $result[0]["cuantum_penalizare"] == "70") echo 'selected="selected"'; ?>>70%</option>
										<option value="80%" <?php if($result[0]["cuantum_penalizare"] == "80%" || $result[0]["cuantum_penalizare"] == "80") echo 'selected="selected"'; ?>>80%</option>
										<option value="90%" <?php if($result[0]["cuantum_penalizare"] == "90%" || $result[0]["cuantum_penalizare"] == "90") echo 'selected="selected"'; ?>>90%</option>
										<option value="100%" <?php if($result[0]["cuantum_penalizare"] == "100%" || $result[0]["cuantum_penalizare"] == "100") echo 'selected="selected"'; ?>>100%</option>
									</select>
							</div>
							<div class="form-group mb-3">
									...
									<select name="clauza_circumstante" class="custom-select">
										<option selected>Alege</option>
										<option value="Da" <?php if($result[0]["clauza_circumstante"] == "Da" || $result[0]["clauza_circumstante"] == "DA") echo 'selected="selected"'; ?>>Da</option>
										<option value="Nu" <?php if($result[0]["clauza_circumstante"] == "Nu" || $result[0]["clauza_circumstante"] == "NU") echo 'selected="selected"'; ?>>Nu</option>
									</select>
							</div>
							<div class="form-group mb-3">
