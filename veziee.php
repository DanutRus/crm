<?php		
	...
	$sql = "SELECT * FROM clientienergie " . $queryCondition;
	$href = 'veziee.php';					
	...
	if(isset($_POST["export"])) {
		$query2 = "SELECT * FROM clientienergie";
		$result2 = $db_handle->executeQuery($query2);
		$fisier = "clienti-EE-nova".date('d-m-Y').".xls";
            ...
            <div class='container'>
                <div class='card'>
                    <div class='card-header'>
                        <h1>Clienti energie electrica</h1>
                    </div>
                    <div class='card-body'>
					<form name="" method="post" action="veziee.php">
					<div class="mb-3">
					<p>
						...
						<table class="table">
							...
							<tbody>
								...
								<td>
									<a class="btn btn-dark btn-sm" href="actualizeaza.php?id=<?php echo $result[$k]["id"]; ?>">Actualizeaza</a> 
								</td>
								<td>
									<a class="btn btn-dark btn-sm" href="act_aditional.php?id=<?php echo $result[$k]["id"]; ?>">AA</a> 
									<!-- <a class="btn btn-dark btn-sm" href="sterge.php?action=delete&id=<?php echo $result[$k]["id"]; ?>">Sterge</a> -->
								</td>
								</tr>
							<tbody>
