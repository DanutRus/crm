...
if(!empty($_POST["submit"])) {
	$query = "INSERT INTO clientign(denumire_client, tip_client, status_client, agent_nova, judet, email_agent, nr_contract, data_semnare, data_intrare_ct, data_finalizare_ct, persoana_contact_companie, email_contact, telefon_contact, administrator_companie, localitate, strada_comuna, numar, cod_postal, consum_estimatian21, consum_estimatfeb21, consum_estimatmar21, consum_estimatapr21, consum_estimatmai21, consum_estimatiun21, consum_estimatiul21, consum_estimataug21, consum_estimatsep21, consum_estimatoct21, consum_estimatnoi21, consum_estimatdec21, nr_aa, tip_pret, data_garantare, pret_ianuarie20, pret_februarie20, pret_martie20, pret_aprilie20, pret_mai20, pret_iunie20, pret_iulie20, pret_august20, pret_septembrie20, pret_octombrie20, pret_noiembrie20, pret_decembrie20, clauza_penalitati_rez, cuantum_penalizare, clauza_circumstante, termen_plata, observatii, reg_comert, cui, iban_cont, banca_cont, distributiegn, srm) 
	VALUES('".$_POST["denumire_client"]."','".$_POST["tip_client"]."','".$_POST["status_client"]."','".$_POST["agent_nova"]."','".$_POST["judet"]."','".$_POST["email_agent"]."','".$_POST["nr_contract"]."','".$_POST["data_semnare"]."','".$_POST["data_intrare_ct"]."','".$_POST["data_finalizare_ct"]."','".$_POST["persoana_contact_companie"]."','".$_POST["email_contact"]."','".$_POST["telefon_contact"]."','".$_POST["administrator_companie"]."','".$_POST['localitate']."','".$_POST["strada_comuna"]."','".$_POST["numar"]."','".$_POST["cod_postal"]."','".$_POST["consum_estimatian21"]."','".$_POST["consum_estimatfeb21"]."','".$_POST["consum_estimatmar21"]."','".$_POST["consum_estimatapr21"]."','".$_POST["consum_estimatmai21"]."','".$_POST["consum_estimatiun21"]."','".$_POST["consum_estimatiul21"]."','".$_POST["consum_estimataug21"]."','".$_POST["consum_estimatsep21"]."','".$_POST["consum_estimatoct21"]."','".$_POST["consum_estimatnoi21"]."','".$_POST["consum_estimatdec21"]."','".$_POST["nr_aa"]."','".$_POST["tip_pret"]."','".$_POST["data_garantare"]."','".$_POST["pret_ianuarie"]."','".$_POST["pret_februarie"]."','".$_POST["pret_martie"]."','".$_POST["pret_aprilie"]."','".$_POST["pret_mai"]."','".$_POST["pret_iunie"]."','".$_POST["pret_iulie"]."','".$_POST["pret_august"]."','".$_POST["pret_septembrie"]."','".$_POST["pret_octombrie"]."','".$_POST["pret_noiembrie"]."','".$_POST["pret_decembrie"]."','".$_POST["clauza_penalitati_rez"]."','".$_POST["cuantum_penalizare"]."','".$_POST["clauza_circumstante"]."','".$_POST["termen_plata"]."','".$_POST["observatii"]."', '".$_POST["reg_comert"]."', '".$_POST["cui"]."', '".$_POST["iban_cont"]."', '".$_POST["banca_cont"]."', '".$_POST["distributiegn"]."', '".$_POST["srm"]."')";
    ...
    if(!$result){
		...
		header("Location:adauga_clientGN.php");
...
<div class='dashboard'>
	<div class="dashboard-nav">
		...
		<nav class="dashboard-nav-list">
			...
			<a href="adauga_clientGN.php" class="dashboard-nav-item active">Adauga client GN</a>
            ...
            <div class='container'>
                <div class='card'>
                    <div class='card-header'>
                        <h1>Adauga client Gaze Naturale</h1>
                    </div>
                    <div class='card-body'>
						...
						<h3 class="sub-subtitlu">Informatii client</h3>
							...
							<div class="row">
								<div class="col">
										...
										<select name="agent_nova" class="custom-select">
											...
											<option value="BRM GN">BRM GN</option>
										</select>
								</div>
							</div>
							<br />
							...
							<div class="row">
								<div class="col">
										...
										<input type="text" name="consum_estimatian21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Februarie</span>
										<input type="text" name="consum_estimatfeb21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Martie</span>
										<input type="text" name="consum_estimatmar21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Aprilie</span>
										<input type="text" name="consum_estimatapr21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Mai</span>
										<input type="text" name="consum_estimatmai21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Iunie</span>
										<input type="text" name="consum_estimatiun21" class="form-control">
								</div>
							</div>
							<div class="row">
								<div class="col">
										<span>Consum Iulie</span>
										<input type="text" name="consum_estimatiul21" class="form-control">
								</div>
								<div class="col">
										<span>Consum August</span>
										<input type="text" name="consum_estimataug21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Septembrie</span>
										<input type="text" name="consum_estimatsep21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Octombrie</span>
										<input type="text" name="consum_estimatoct21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Noiembrie</span>
										<input type="text" name="consum_estimatnoi21" class="form-control">
								</div>
								<div class="col">
										<span>Consum Decembrie</span>
										<input type="text" name="consum_estimatdec21" class="form-control">
								</div>
							</div>
							<br />
